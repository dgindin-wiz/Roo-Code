...
describe("CodeParser", () => {
	...
	describe("parseFile", () => {
		...
		it("should queue very large child node lists without overflowing the call stack", async () => {
			const tinyChild = {
				text: "x",
				children: [],
				type: "identifier",
			...
			const wideGeneratedNode = {
				text: "x".repeat(20_000),
				children: Array.from({ length: 120_000 }, () => tinyChild),
				type: "generated_declaration",
				startPosition: { row: 0 },
				endPosition: { row: 1 },
				childForFieldName: vi.fn(),
				parent: null,
			...
			mockLanguageParser.js.query.captures.mockReturnValueOnce([{ node: wideGeneratedNode }])

			await expect(
				parser.parseFile("generated.js", {
					content: "// Code generated by a tool. DO NOT EDIT.\n" + "x".repeat(20_000),
				}),
			).resolves.toEqual([])
		})
